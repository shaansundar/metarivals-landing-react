        ...
        <div className="w-full h-screen md:h-[50vw] relative">
            <div className='w-full md:mx-4 h-full flex md:flex-row flex-col absolute items-start z-10 justify-center'>
                ...
                <div className='flex-col flex items-center justify-center w-full md:w-1/3 text-white text-center h-1/3 md:h-full'>
                    <h1 style={{ fontFamily: 'Anton' }} class="lg:text-6xl w-full py-4 italic text-center md:text-center text-4xl text-transparent bg-clip-text bg-gradient-to-t from-Dark to-Light">Why Metarivals?</h1>

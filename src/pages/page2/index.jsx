...
export default function Page2() {
    return (
        <div className="w-full h-screen md:h-[50vw] relative">
            <div className='w-full h-full flex md:flex-row flex-col-reverse absolute items-start z-10 justify-center'>
                <div className='w-full md:w-1/2 h-1/2 md:h-full'>
                    <div class="text-white w-full h-full md:mx-4 flex flex-col items-center justify-center">
                        <h1 style={{ fontFamily: 'Anton' }} class="lg:text-6xl w-full p-4 italic text-center md:text-left text-4xl text-transparent bg-clip-text bg-gradient-to-t from-Dark to-Light font-['']">What is Metarivals?</h1>

...
export default function Page7() {
    return (
        <div className="w-full text-white h-[50vh] md:h-[65vw] max-h-[2273px] relative">
            <div className='w-full h-full flex py-10 flex-col absolute items-center z-10 justify-center'>
                <h1 style={{ fontFamily: 'Anton' }} class="lg:text-6xl w-full p-4 italic text-center text-4xl text-transparent bg-clip-text bg-gradient-to-t from-Dark to-Light">Roadmap</h1>

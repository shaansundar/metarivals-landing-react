...
export default function Page8() {
    return (
        <div className="w-full text-white h-screen md:h-[70vh] lg:h-[65vw] max-h-[2273px] relative">
            <div className='w-full h-full flex my-4 flex-col absolute items-center z-10 justify-start'>

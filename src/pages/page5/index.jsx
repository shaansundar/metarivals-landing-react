...
export default function Page5() {
    ...
    <p class="text-center px-4">$MRVL is MetaRivals’ deflationary token which has a lot of utility and use cases, ensuring a sustainable and profitable P2E experience</p>
